      ...
      {aToken && (
        <ul className="text-white mt-5">
          ...
          >
            ...
            <p className="hidden md:block hover:scale-105">Add Staffs</p>
          </NavLink>
          ...
          >
            ...
            <p className="hidden md:block hover:scale-105">Staffs List</p>
          </NavLink>
          ...
          >
            ...
            <p className="hidden md:block hover:scale-105">Add Services</p>
          </NavLink>
      ...
      {sToken && (
        <ul className="text-white mt-5">
          ...
          >
            ...
            <p className="hover:scale-120 hidden md:block">Dashboard</p>
          </NavLink>
          ...
          >
            ...
            <p className="hover:scale-120 hidden md:block">Appointments</p>
          </NavLink>
          ...
          >
            ...
            <p className="hover:scale-120 hidden md:block">Profile</p>
          </NavLink>
        </ul>
      )}
    </div>
