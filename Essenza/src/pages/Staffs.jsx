              ...
              >
                ...
                {item.available ? (
                  <button
                    ...
                    className="font-bold  px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded shadow-lg transform hover:scale-105 transition-transform duration-500 cursor-pointer "
                  >
                    Availability
                  </button>
                ) : (
